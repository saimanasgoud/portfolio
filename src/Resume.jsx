...
export default function Resume() {
  ...
  const pdfUrl = "/saimanas/SaimanasResume.pdf"; // Update path as needed
  ...
  return (
    <main className="w-full max-w-5xl mx-auto text-center py-20 px-4 mt-10 bg-gray-100 min-h-screen">
      ...
      <div className="flex justify-center space-x-6 mb-10">
        <button
          ...
          className="px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
