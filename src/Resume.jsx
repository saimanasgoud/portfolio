...
export default function Resume() {
  ...
  return (
    <main className="mx-auto text-center py-24 px-4 mt-27 min-h-screen bg-gradient-to-b from-gray-100 to-gray-200 dark:from-gray-900 dark:to-gray-600 transition">
